...
class GenerateConcoursDoublettePdfUseCase {
  ...
  Future<Uint8List> call(String concoursId) async {
    ...
    return pdfRepository.generateConcoursDoublettePdf(pdfModel);
  }
}
