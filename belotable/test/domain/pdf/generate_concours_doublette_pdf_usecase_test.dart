...
void main() {
  ...
  group('GenerateConcoursDoublettePdfUseCase', () {
    ...
    setUp(() {
      ...
      useCase = GenerateConcoursDoublettePdfUseCase(
    ...
    test('generates PDF when concours exists', () async {
      ...
      when(
        () => mockPdfRepository.generateConcoursDoublettePdf(any()),
    ...
    test('maps concours to PDF model correctly', () async {
      ...
      final captured =
          verify(
                () => mockPdfRepository.generateConcoursDoublettePdf(
                  captureAny(),
                ),
              ).captured.single
