...
3. Using by default .github/pr_descriptions/<current-branch>.md when user does not provide description.
...
- If user does not provide description text or file path, check if .github/pr_descriptions/<current-branch>.md exists.
