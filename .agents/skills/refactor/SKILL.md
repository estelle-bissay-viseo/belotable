...
5. Create new tests if you think they are necessary to cover any new code or edge cases introduced by your refactorings, or to improve the overall test coverage of the project.